const url = "http://localhost:8080/P1-Michael/employee/";

document.getElementById("pastButton").addEventListener("click", completeReimbursementFunction);
document.getElementById("pendingButton").addEventListener("click", pendingFunction);
document.getElementById("submit").addEventListener("click", onSubmit);
document.getElementById("logoutButton").addEventListener("click", backFunction);

function backFunction(){
    document.getElementById("logoutButton").innerText = "You're going back!";
    location.href="index.html";
}

async function completeReimbursementFunction(){
